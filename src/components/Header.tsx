          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-1 px-2.5 sm:px-3 py-1.5 text-xs font-semibold rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 transition-colors"
                title="स्थान छनोट (Change Location)"
              >
                <MapPin className="w-3.5 h-3.5 text-red-500 shrink-0" />
                <span className="truncate max-w-[70px] sm:max-w-[100px]">{currentLocation.nameNepali.split(' ')[0]}</span>
              ...
              {showLocationMenu && (
                <div className="absolute right-0 mt-2 w-72 max-h-96 overflow-y-auto bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 py-2 z-50 animate-in fade-in zoom-in-95">
                  <div className="px-3 py-1.5 text-[11px] font-bold text-slate-400 uppercase tracking-wider border-b border-slate-100 dark:border-slate-700">
                    नेपाल तथा अन्तर्राष्ट्रिय स्थान
                  </div>
